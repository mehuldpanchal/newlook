...
export const metadata: Metadata = {
  title: "Our Services",
  description:
    "Explore our comprehensive paving, masonry, roofing, and siding services. From driveways to roof replacements, we have you covered.",
};
      ...
      <section className="relative py-32 pt-40 bg-primary">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto mb-8">
            Commercial & Residential services including paving, masonry, roofing, siding, and more.
          </p>
      ...
      <section className="py-20 bg-accent">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 max-w-2xl mx-auto mb-8">
            No problem! Contact us for a free consultation and we&apos;ll help you
